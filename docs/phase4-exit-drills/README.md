...
## Drill B — `review:human` (red-zone touch)

1. Branch `spec/phase4-exit-human-redzone` from `main`.
...
## Drill C — `blocked` (critical finding)

1. Branch `spec/phase4-exit-blocked-drill` from `main` with any tiny non–red-zone diff
